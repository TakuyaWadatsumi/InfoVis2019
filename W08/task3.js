function main()
{
    ...
    {
        var id = faces[i];
        var S0 = Math.round((255/0.7)*(scalars[ id[0] ]-0.1));
        var S1 = Math.round((255/0.7)*(scalars[ id[1] ]-0.1));
        var S2 = Math.round((255/0.7)*(scalars[ id[2] ]-0.1));
